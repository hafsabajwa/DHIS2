...
var _registration = require("../lib/registration");
...
class OfflineInterface {
  ...
  async startRecording({
    ...
    this.offlineEvents.once(_constants.swMsgs.recordingError, ({
      msg
    }) => {
  ...
  async removeSection(sectionId) {
    ...
    return Promise.all([caches.delete(sectionId), !!sectionExists && db.delete(_sectionsDb.SECTIONS_STORE, sectionId).then(() => true)]).then(([cacheDeleted, dbEntryDeleted]) => cacheDeleted || dbEntryDeleted);
  }
