...
exports.checkForSWUpdateAndReload = checkForSWUpdateAndReload;
  ...
  if ('serviceWorker' in navigator) {
    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        ...
        checkValidSW(swUrl, config); // Add some additional logging to localhost, pointing developers
...
/* config */
  ...
  if (reg !== null && reg !== void 0 && reg.active && navigator.serviceWorker.controller === null) {
