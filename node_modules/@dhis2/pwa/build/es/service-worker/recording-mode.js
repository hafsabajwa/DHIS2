...
import { openSectionsDB, SECTIONS_STORE } from '../lib/sections-db'; // '[]' Fallback prevents error when switching from pwa enabled to disabled
...
export function shouldRequestBeRecorded({
  url,
  event
}) {
