...
const Alerts = () => {
  ...
  (0, _react.useEffect)(() => {
    if (alertManagerAlerts.length > 0 || alertStackAlerts.length > 0) {
      setAlertStackAlerts(mergeAlertStackAlerts(alertStackAlerts, alertManagerAlerts));
    }
  }, [alertManagerAlerts]);
  return /*#__PURE__*/_react.default.createElement(_ui.AlertStack, null, alertStackAlerts.map(({
    message,
    remove,
    id,
    options: {
  ...
  }) => /*#__PURE__*/_react.default.createElement(_ui.AlertBar, _extends({}, props, {
    key: id,
    onHidden: () => {
      onHidden && onHidden();
