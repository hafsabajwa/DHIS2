...
var _Button = _interopRequireDefault(require("./styles/Button.style"));

var _ErrorBoundary = _interopRequireDefault(require("./styles/ErrorBoundary.style"));
...
const UIButton = ({
  ...
  id: _Button.default.__hash
}, _Button.default), /*#__PURE__*/_react.default.createElement("button", {
  onClick: onClick,
  className: `jsx-${_Button.default.__hash}`
}, children));
  ...
  render() {
    ...
    if (this.state.error) {
      return /*#__PURE__*/_react.default.createElement("div", {
        className: `jsx-${_ErrorBoundary.default.__hash}` + " " + ((0, _classnames.default)('mask', {
          fullscreen
        }) || "")
      }, /*#__PURE__*/_react.default.createElement(_style.default, {
        id: _ErrorBoundary.default.__hash
      }, _ErrorBoundary.default), /*#__PURE__*/_react.default.createElement("div", {
        className: `jsx-${_ErrorBoundary.default.__hash}` + " " + "container"
      }, /*#__PURE__*/_react.default.createElement("h1", {
        className: `jsx-${_ErrorBoundary.default.__hash}` + " " + "message"
      }, _d2I18n.default.t('Something went wrong')), onRetry && /*#__PURE__*/_react.default.createElement("div", {
        className: `jsx-${_ErrorBoundary.default.__hash}` + " " + "retry"
        ...
        className: `jsx-${_ErrorBoundary.default.__hash}` + " " + "drawerToggle"
        ...
        className: `jsx-${_ErrorBoundary.default.__hash}` + " " + ((0, _classnames.default)('drawer', {
          hidden: !this.state.drawerOpen
        }) || "")
      }, /*#__PURE__*/_react.default.createElement("div", {
        className: `jsx-${_ErrorBoundary.default.__hash}` + " " + "errorIntro"
      }, /*#__PURE__*/_react.default.createElement("p", {
        className: `jsx-${_ErrorBoundary.default.__hash}`
        ...
        className: `jsx-${_ErrorBoundary.default.__hash}` + " " + "errorDetails"
